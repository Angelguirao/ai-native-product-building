...
export const handbookResources: HandbookResource[] = [
  ...
  },
  {
    ...
    kind: "course",
    note: "Packaged PM workspace — 242 skills, 11 workflows, subagents, MCPs, context memory for Cursor and Claude Code.",
    chapters: [
      "00-principles",
      "01-mindset",
      "03-discovery",
  ...
  },
  {
    ...
    url: "https://goremy.ai/",
    kind: "article",
    note: "Product agent team — idea to production plus roadmap, marketing, analytics, and post-ship ops.",
    chapters: ["10-agentic-development", "11-product-engineering-os", "16-scaling"],
  },
  {
    id: "harness-engineering-ker",
    title: "The architect's guide to harness engineering",
    url: "https://x.com/thealexker/status/2076741193367761378",
    kind: "article",
    note: "How to choose or build the harness that wraps models — replicable team capability vs raw prompting.",
    chapters: ["10-agentic-development", "11-product-engineering-os"],
  },
  {
    id: "business-engineer-agent-os",
    title: "The Business Engineer Agent OS",
    url: "https://businessengineer.ai/p/the-business-engineer-agent-os",
    kind: "course",
    note: "Gennaro Cuofano — agent harness and Builder-PM operating substrate for Claude Code and Codex.",
    chapters: ["01-mindset", "11-product-engineering-os", "17-teams"],
  },
  {
    id: "builder-pm-manifesto",
    title: "The Builder-PM Manifesto",
    url: "https://businessengineer.ai/p/the-builder-pm-manifesto",
    kind: "article",
    note: "Product management rebuilt for the AI era — prototype as spec, loop ownership, overhang bets.",
    chapters: ["01-mindset", "11-product-engineering-os", "15-iteration"],
  },
];
...
export const spinOuts: Record<string, Omit<FootnotesSpinOut, "chapterId">> = {
  ...
  "11-product-engineering-os": {
    slug: "product-engineering-os",
    title: "Product engineering OS",
    url: `${FOOTNOTES_BASE}/thought/product-engineering-os.html`,
  },
  "11-architecture": {
